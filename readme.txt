SLE_DATA_LABELING_TOOL_NOV Executable
...
================================
-run_SLE_DATA_LABELING_TOOL_NOV.sh (shell script for temporarily setting environment 
                                    variables and executing the application)
   -to run the shell script, type
   
       ./run_SLE_DATA_LABELING_TOOL_NOV.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2023b, run the shell script as:
       ...
       ./run_SLE_DATA_LABELING_TOOL_NOV.sh /mathworks/home/application/R2023b
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_SLE_DATA_LABELING_TOOL_NOV.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure SLE_DATA_LABELING_TOOL_NOV.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r SLE_DATA_LABELING_TOOL_NOV.zip SLE_DATA_LABELING_TOOL_NOV.app
    or the tar command 
    tar -cvf SLE_DATA_LABELING_TOOL_NOV.tar SLE_DATA_LABELING_TOOL_NOV.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/R2023b/runtime/maca64:MR/R2023b/sys/os/maca64:MR/R2023b/bin/maca64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_SLE_DATA_LABELING_TOOL_NOV.sh 
